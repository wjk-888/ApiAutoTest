...
#####################################get请求，不带参数#######################################
#获取用户列表
# ip 地址 url="http://192.168.150.222:8081/futureloan/mvc/api/member/list"
#接口
...
#####################################get请求，不带参数#######################################
#注册接口，参数拼接在URL的后面，？后面是参数，多个参数舒勇&连接
# url="http://jy001:8081/futureloan/mvc/api/member/register?mobilephone=18145678911&pwd=123456"
# #发送get请求
# r=requests.get(url)
# #打印响应,文本格式的
# print(r.text)
...
assert '贵州联通' in r.text

url="https://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=13885565311"
r=requests.get(url)
print(r.text)
assert '贵州移动' in r.text
